...
<div class="wpforms-panel-content-section wpforms-panel-content-section-uawpf-webhooks">
	<div class="wpforms-panel-content-section-title">
		...
		<button type="button" class="<?php echo esc_attr( $args['add_new_btn_classes'] ); ?>" data-block-type="uawpf-webhook" data-next-id="<?php echo absint( $args['next_id'] ); ?>"><?php esc_html_e( 'Add New Webhook', 'ultrawpf-webhooks' ); ?></button>
	</div>

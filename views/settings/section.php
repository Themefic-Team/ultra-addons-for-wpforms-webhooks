...
?>
<div class="wpforms-panel-content-section wpforms-panel-content-section-uawpf-webhooks wpforms-panel-content-section-uawpf-webhooks">
	<div class="wpforms-panel-content-section-title">
		<?php esc_html_e( 'Ultra Addons Webhooks', 'ultrawpf-webhooks' ); ?>
		<button type="button"
			class="<?php echo esc_attr( $args['add_new_btn_classes'] ); ?> wpforms-uawpf-webooks-add wpforms-webooks-add"
